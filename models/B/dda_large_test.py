...
class SDL_attention_large(nn.Module):
    def __init__(self, inplanes, planes, kernel_size=1, stride=1, mode="ch"):
        super(SDL_attention_large, self).__init__()
        ...
        self.conv_up = nn.Linear(self.planes,self.planes, bias=False)
...
if __name__ == "__main__":
    ...
    model = SDL_attention_large(512, 512)
    out = model(x)
    print(out.shape)
