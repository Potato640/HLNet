...
def run(
    ...
    if save_json and len(jdict):
        ...
        anno_json = str(Path('/home/lyh/envir/yolov5-7.0/instances_val2017.json'))  # annotations json
...
def parse_opt():
    ...
    parser.add_argument('--project', default=ROOT / 'runs_val/t', help='save to project/name')
    parser.add_argument('--name', default='yolov5s-ciou-wlsk-both-0.5-0.5-0', help='save to project/name')
